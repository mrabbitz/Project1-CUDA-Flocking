...
Now, this result represents the ± offset in each dimension of the given boid's cell such that the range of cells are those that contain the boids we need to iterate through to apply the three boid rules to a given boid.
